# A variation of the heater fan that uses tachometer feedback to shutdown the printer when the fan malfunctions
#
# Copyright (C) 2016-2023  LDO Systems (david@ldomotors.com)
#
...
class PrinterSafetyFan:
    def __init__(self, config):
        ...
        self.min_rpm = config.getint("min_rpm", 1, minval=0)
...
def load_config_prefix(config):
    return PrinterSafetyFan(config)
